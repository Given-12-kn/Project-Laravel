<nav class="bg-gray-100">
  <div class="mx-auto max-w-7xl px-2 md:px-6 lg:px-8">
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 md:static md:inset-auto md:ml-6 md:pr-0">
          ...
          <div class="relative ml-3">
              ...
              <a href="{{url('home/')}}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>
  ...
  <div class="md:hidden hidden transition-all duration-200 transform origin-top scale-y-0" id="mobile-menu">
      ...
      <a href="{{url('dosen/dosenKeluhan')}}" class="block rounded-md px-3 py-2 text-base font-medium text-black hover:bg-blue-400 hover:text-black">Keluhan</a>
